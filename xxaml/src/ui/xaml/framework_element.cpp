...
xresult framework_element::initialize_property()
{
	...
	dependency_property* margin_property = nullptr;
	...
	margin_property_ = margin_property;
	return xr;
}
...
type_name framework_element::type() const { return TYPE( xxaml__ui__xaml__framework_element ); }
